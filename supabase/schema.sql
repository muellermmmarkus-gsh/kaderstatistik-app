...
-- performance/motivation/discipline/player_notes/excused sind nur bei
-- Terminen vom Typ 'training' im UI sichtbar und relevant, registered nur
-- bei Terminen vom Typ 'game'.
...
-- Spielergebnis pro Spieltermin. team_a/team_b = die beiden Mannschaften in
-- angezeigter Reihenfolge (Heimmannschaft zuerst). finished_at gesetzt =
-- Spiel ueber "Spiel beendet" archiviert (erscheint unter "Letzte Ergebnisse").
